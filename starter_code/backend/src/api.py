...
def get_drinks():
    ...
    drinks_short = [drink.short() for drink in drinks_list]
...
def get_drinks_detail(jwt):
    ...
    drinks_long = [drink.long() for drink in drinks_list]
...
def edit_drink(jwt, *args, **kwargs):
...
def delete_drink(jwt, *args, **kwargs):
